    ...
    <main id="page-T087" class="site_main">
      ...
      <div class="looksort settement_manager">
        ...
        <ul class="report-steps">
          <li class="report-steps__item is-active"><a href="">パークサポーター未回収管理</a></li>
          <li class="report-steps__item">
            <nuxt-link :to="{ name: 'admin-payment-guardian-unpaid-payment'}">
              ユーザー未回収管理
            </nuxt-link>
          </li>
        </ul>
...
export default {
  name: "SupporterUnpaidPaymentPage",
  components: {
    UnpaidPaymentTable
  },
  layout: 'admin',
  ...
  async asyncData(context) {
    try {
      const unpaidPayments = [{
        user: {first_name: "高升", last_name: "良子", first_kana: "たかます", last_kana: "よしこ"},
        status: 0,
        billing_date: "2023-01-26",
        payment_date: "2022-08-15",
        amount: 21000,
        deposit: 21000,
        memo: "memo text"
      }, {
        user: {first_name: "坂口", last_name: "桃香", first_kana: "さかぐち", last_kana: "ももこ"},
        status: 1,
        billing_date: "2021-06-01",
        payment_date: "2021-08-15",
        amount: 35e3,
        deposit: 35e3,
        memo: "memo text"
      }, {
        user: {first_name: "美王", last_name: "彩華", first_kana: "みおう", last_kana: "あやか"},
        status: 0,
