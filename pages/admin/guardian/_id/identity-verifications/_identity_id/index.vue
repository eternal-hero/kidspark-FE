<template>
  <div class="wrapper">
    ...
    <main id="page-T039" class="site_main">
      ...
      <exeo-guardian-header :guardian="guardian" @edit="transitToEditPage"></exeo-guardian-header>
      <div class="col2_block f-ai-start">
        <exeo-guardian-navigation-window></exeo-guardian-navigation-window>
        <exeo-table-guardian-identity-application-show :identity-application="identity">
        </exeo-table-guardian-identity-application-show>
      </div>
    </main>
  </div>
</template>
...
import ExeoTableGuardianIdentityApplicationShow from "@/components/table/ExeoTableGuardianIdentityApplicationShow.vue";
import IdentityApplicationService from "@/services/admin/guardian/IdentityApplicationService";

export default {
  name: "ApplicationIdentityShow",
  components: {
    ExeoTableGuardianIdentityApplicationShow,
